...
description: >
  学术演示与海报 — 涵盖研究会议slides、答辩、seminar、学术海报。
  支持 PowerPoint 和 LaTeX Beamer，含结构设计、模板、时间指导、视觉校验。
  研究海报支持 LaTeX (beamerposter/tikzposter/baposter) 和 HTML/CSS→PDF/PPTX。

  触发词 (中文): 学术PPT、会议slides、答辩slides、seminar演示、
  论文答辩PPT、研究海报、学术海报、conference poster、LaTeX海报、Beamer slides。

  Trigger (EN): academic slides, conference presentation, thesis defense,
  seminar talk, research poster, academic poster, LaTeX beamer, Beamer poster,
  scientific poster, research presentation.

  通用PPTX操作 → pptx skill。网页HTML演示 → guizang-ppt-skill。
