...
description: >
  系统文献综述与文献检索 — 多数据库检索（PubMed/arXiv/bioRxiv/Semantic Scholar等），
  含引文管理（Google Scholar/PubMed/DOI→BibTeX）和结构化综述写作。
  输出专业Markdown/PDF，多引文格式（APA/Nature/Vancouver）。

  触发词: 文献综述、literature review、系统综述、systematic review、
  找论文、查文献、find papers、search papers、citation management、
  BibTeX、DOI to BibTeX、文献检索、meta-analysis。

  论文质量评估 → scholar-evaluation。手稿写作 → scientific-writing。
---
