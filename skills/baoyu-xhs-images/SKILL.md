...
description: >
  生成小红书/小绿书/微信图文风格的信息图卡片系列。12种视觉风格、8种布局、3种调色板，
  将内容拆成1-10张卡通风格图片卡片，优化社交媒体互动。

  触发词: 小红书图片、小红书种草、小绿书、微信图文、微信贴图、image cards、
  图片卡片、social media infographic、XHS images。

  发布到社交媒体平台 → baoyu-social-publisher。
---
