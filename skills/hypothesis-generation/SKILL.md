...
description: >
  科学假设生成 — 从实验观察或数据出发，形成可验证假设（含预测/机制提案/实验设计）。
  遵循科学方法框架。

  触发词: 假设生成、hypothesis、形成假设、可验证预测、testable hypothesis、
  propose mechanism、实验设计。

  创意探索 → brainstorming。证据评估 → consciousness-council。
---
