...
description: >
  TikTok 调研与数据采集 — 用本地 Chrome 真实登录态搜索、浏览、采集、截图、结构化导出。
  不依赖第三方 TikTok API，仅读取可见页面、滚动、截图和整理。

  触发词 (中文): TikTok搜索、TT搜索、搜TikTok关键词、搜索TikTok博主、TikTok调研、
  TikTok选题研究、TikTok带货方向、TikTok内容分析、采样TikTok视频、采集TikTok作品、
  TikTok博主主页、TikTok博主最近作品、提取TikTok视频链接/标题/互动数据、
  TikTok截图留证、TikTok竞品调研、TikTok品类调研。

  Trigger (EN): TikTok search, search TikTok keywords, find TikTok creators,
  TikTok research, TikTok content research, TikTok trend research,
  TikTok creator discovery, scrape TikTok videos, extract TikTok links/titles/engagement,
  TikTok screenshots, TikTok competitor analysis, TikTok category research,
  sample TikTok content, TikTok creator profile scraping.

  下载/分析/剪辑视频 → 用 bggg-tiktok-studio。
---
