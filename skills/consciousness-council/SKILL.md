...
description: >
  多视角审议与情景分析 — 多专家角色讨论任何决策/难题/创意挑战，
  同时覆盖 What-If 情景探索（多分支可能性分析、风险/最佳/最坏情况）
  和科学证据质量评估（GRADE/Cochrane风险偏倚/实验设计验证/混杂因素识别）。

  触发词: council mode、mind council、多视角分析、专家审议、
  what if、情景分析、what would happen if、scenario analysis、
  best case worst case、风险分析、可能性空间、stress-test、
  评估证据、experimental design、bias analysis、critical appraisal。

  创意探索 → brainstorming。假设验证 → hypothesis-generation。
---
