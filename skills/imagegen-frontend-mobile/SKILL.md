...
description: >
  移动App设计参考图 — iOS/Android/跨平台App屏幕概念设计，
  强调层级清晰、多屏一致性、受控调色板、纹理表面、image-led构图、
  默认嵌在Phone mockup中展示。

  触发词: app设计图、iOS mockup、Android screen design、
  mobile app concept、手机App界面。

  网页设计图 → imagegen-frontend-web。通用生图 → baoyu-image-gen。
---
