...
description: >
  网页设计参考图生成 — 为每个 section 生成独立大尺寸横版设计图，
  含品牌识别系统/logo/视觉世界观。强调构图多样性、叙事概念、第二眼细节、统一调色板。
  覆盖：着陆页、营销站、产品页、品牌设计。

  触发词: 网页设计图、landing page design image、website mockup、
  brand kit、品牌视觉、brand guidelines、品牌识别。

  移动App设计图 → imagegen-frontend-mobile。通用生图 → baoyu-image-gen。
---
