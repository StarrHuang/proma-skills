...
user-invocable: true
description: >
  花叔Design（Huashu-Design）— 一体化 HTML 设计引擎，已整合前端设计、动画、风格预设与网站改版能力。
  HTML是工具不是媒介，根据任务化身为 UX设计师/动画师/幻灯片设计师/原型师，避免 web design tropes。

  **涵盖领域**：
  - 高保真交互原型 / hi-fi prototype / UI mockup / app原型 / iOS原型
  - 设计变体探索 / 多方案对比 / Tweaks 实时调参
  - HTML 演示幻灯片 / 演讲 deck / 1920×1080 幻灯片
  - GSAP 动画 / 时间轴驱动 motion design / ScrollTrigger 滚动叙事
  - 网页设计 / landing page / 品牌官网 / 作品集 / 营销页
  - 网站改版 / redesign / 设计审计 → 反 AI slop → 升级
  - 风格预设：Brutalist（军事终端）/ Minimalist（编辑风）/ Swiss Style / 等
  - HTML动画→MP4/GIF视频导出（25/60fps + palette优化 + 场景BGM）
  - 设计方向顾问：5流派×20种设计哲学 → 推荐3个方向 → 并行生成3个视觉Demo
  - 专家评审：哲学一致性/视觉层级/细节执行/功能性/创新性各10分+修复清单
  - 代码实现：image-to-code / 设计稿→代码

  **触发词 (中文)**: 做原型、设计Demo、交互原型、HTML演示、动画Demo、设计变体、hi-fi设计、
  UI mockup、设计探索、做个HTML页面、做个可视化、app原型、iOS原型、移动应用mockup、
  网页设计、着陆页、landing page、网站改版、redesign、做个网站、导出MP4/GIF、
  60fps视频、设计风格/方向/哲学、配色方案、选个风格、做个好看的、评审设计、
  Brutalist风格、极简设计、编辑风、瑞士国际主义、军事终端风、GSAP动画。

  **Trigger (EN)**: prototype, interactive demo, hi-fi design, UI mockup, HTML prototype,
  app prototype, iOS mockup, landing page, web design, website redesign, design audit,
  GSAP animation, ScrollTrigger, motion design, export MP4/GIF, design style,
  design direction, design review, brutalist, minimalist, Swiss Style, editorial,
  soft-skill, high-end agency design, upgrade website, make it look expensive.

  轻量着陆页/作品集 → 也可用 design-taste-frontend。图片先行方法 → image-to-code-skill。
---
