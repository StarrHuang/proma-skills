...
description: >
  科学手稿写作 — 完整段落（非bullet points），IMRAD结构，
  两阶段流程（要点大纲+研究数据→流畅成文），含图表/引文/报告标准。

  触发词: 科学写作、写论文、manuscript、scientific writing、
  IMRAD、journal submission、研究论文。

  文献检索 → literature-review。同行评审 → scholar-evaluation。
---
