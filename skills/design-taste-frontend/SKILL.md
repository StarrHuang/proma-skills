...
description: >
  轻量级反AI slop前端设计 — 着陆页、作品集、网站改版专用。先读brief推断设计方向，
  再输出不像模板的界面。真实设计系统、审计优先、交付前严格检查。

  触发词 (中文): 着陆页设计、作品集网站、网站改版、redesign、做个页面、
  设计一个网站首页、品牌页面、做个好看的网页、升级网页设计。

  Trigger (EN): landing page, portfolio site, website redesign, anti-slop,
  make it look premium, upgrade website design, design audit.

  复杂需求（原型/动画/幻灯片/多方案对比/专家评审/MP4导出）→ 用 huashu-design。
---
